...
%
     global   A_EARTH F_EARTH FLAG_GDIST ITER_GDIST %#ok<GVMIS> 
%
%    ================================================================
%   
%C
...
%
      tstell1 =   exist('A_EARTH'); %#ok<EXIST>
      tstell2 =   exist('F_EARTH'); %#ok<EXIST>
...
%
      EETH    =   8.18191908426D-2; %#ok<NASGU>
      ESETH   =   6.69437999013D-3; %#ok<NASGU>
%C
%C
      PIGDES    =   PI;
      FGDES     =   FETH;
